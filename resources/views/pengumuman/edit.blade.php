                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('pengumuman.update', $pengumuman) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_terbit" value="{{ old('tanggal_terbit', $pengumuman->tanggal_terbit) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="isi" rows="8" 
                                      class="w-full border rounded px-3 py-2 @error('isi') border-red-500 @enderror" required>{{ old('isi', $pengumuman->isi) }}</textarea>
                            @error('isi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
