                    ...
                    <form action="{{ route('warga.update', $warga) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="keluarga_id" class="w-full border rounded px-3 py-2 @error('keluarga_id') border-red-500 @enderror" required>
                                    ...
                                    @foreach($keluargas as $keluarga)
                                        <option value="{{ $keluarga->id }}" {{ old('keluarga_id', $warga->keluarga_id) == $keluarga->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nik" value="{{ old('nik', $warga->nik) }}" class="w-full border rounded px-3 py-2 @error('nik') border-red-500 @enderror" required>
                                @error('nik')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $warga->nama) }}" class="w-full border rounded px-3 py-2 @error('nama') border-red-500 @enderror" required>
                                @error('nama')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $warga->tempat_lahir) }}" class="w-full border rounded px-3 py-2 @error('tempat_lahir') border-red-500 @enderror" required>
                                @error('tempat_lahir')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $warga->tanggal_lahir) }}" class="w-full border rounded px-3 py-2 @error('tanggal_lahir') border-red-500 @enderror" required>
                                @error('tanggal_lahir')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="pendidikan" class="w-full border rounded px-3 py-2 @error('pendidikan') border-red-500 @enderror" required>
                                    ...
                                    <option value="D3" {{ old('pendidikan', $warga->pendidikan) == 'D3' ? 'selected' : '' }}>D3</option>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="pekerjaan" value="{{ old('pekerjaan', $warga->pekerjaan) }}" class="w-full border rounded px-3 py-2">
                                @error('pekerjaan')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
